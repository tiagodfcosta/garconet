    ...
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 24:
          ...
          bill.btray.push(_openTray); //por fim, atualizar a bill
...
function deliverOrder(body) {
  var collection, billFound, trayFound, trayUpdated;
  return regeneratorRuntime.async(function deliverOrder$(_context19) {
    while (1) {
      switch (_context19.prev = _context19.next) {
        ...
        case 9:
          trayFound = _context19.sent;
          console.log(trayFound); //provavelmente há um passo anterior
        ...
        case 14:
          trayUpdated = _context19.sent;
          return _context19.abrupt("return", trayUpdated);
...
function killBill() {
  var collection;
  return regeneratorRuntime.async(function killBill$(_context20) {
    while (1) {
